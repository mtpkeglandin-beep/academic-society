            ...
            <div className="space-y-8">
              <div className="flex justify-between items-center">
                ...
                <div className="flex flex-col items-end gap-1.5">
                   ...
                   {ev.pm_attend && (
                     <span className="flex items-center text-[9px] font-black text-slate-400 bg-slate-50 px-3 py-1 rounded-full border border-slate-100 uppercase italic">
                       <CheckCircle2 className="h-3 w-3 mr-1" /> PM Attended
                     </span>
                   )}
                </div>
              </div>
